...
class SouthClassifyFragment : Fragment() {
    ...
    private fun initRecycler(){
        ...
        datas.apply{
            ...
            add(HashDataVo("웨이브 파크", "2020년 7월에 개장한 세계 최대의 인공서핑파크입니다. 레벨에 맞는 안전한 서핑을 즐길 수있는 두가지 구역으로 구성되었습니다.",  R.drawable.icon_surfing))
            add(HashDataVo("함상 전망대", "#250톤급 퇴역 해경 경비함을 활용해서 만든 전시관 오이도 독특한 생태와 역사,전시물을 경험",  R.drawable.icon_ship))
            add(HashDataVo("생금집", "1913년에 개축한 가옥으로 2005년 전면적으로 개축 전통가옥의 생활모습을 잘 살펴볼 수 있습니다.", R.drawable.icon_ceramic))
            ...
            add(HashDataVo("오이도선사유적공원", "약33만제곱미터 규모의 유적공원 하룻밤 보내기 좋은 캠프부터 조가비 공예품 만들기,생태 탐방등의 다양한 체험이 가능합니다.",  R.drawable.icon_ruins))
            ...
            add(HashDataVo("신세계프리미엄아울렛", "220여 개의 국내외 유명 패션브랜드 숍뿐 아니라,자연친화적 조경의 센트럴 가든,반려견과 산책 가능한 펫파크등의 쇼핑과 여가를 같이 즐길 수 있습니다.",  R.drawable.icon_shoppingmall))
