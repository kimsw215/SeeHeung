...
class SouthClassifyFragment : Fragment() {
    ...
    private fun initRecycler(){
        ...
        datas.apply{
            ...
            add(HashDataVo("웨이브 파크", "2020년 7월에 개장한 세계최대의 인공서핑파크입니다. 레벨에 맞는 서핑을 즐길 수 있는 두 가지 구역으로 구성되었습니다.",  R.drawable.icon_surfing))
            add(HashDataVo("함상 전망대", "250톤급 퇴역 해경 경비함을 활용해서 만든 전시관에서 오이도 독특한 생태와 역사,전시물을 경험할 수 있습니다.",  R.drawable.icon_ship))
            ...
            add(HashDataVo("옥구공원", "고향 동산,무궁화 동산,습지원과 연꽃단지 등으로 구성된 친환경적 공원입니다.",  R.drawable.icon_park))
            add(HashDataVo("오이도선사유적공원", "약 33만제곱미터 규모의 유적공원으로 캠프부터 조가비 공예품 제작,생태 탐방등의 체험이 가능합니다.",  R.drawable.icon_ruins))
            ...
            add(HashDataVo("시흥정왕시장", "2016년 7월에 전통시장으로 인정받아 2개동 63개 점포가 등록되어 있습니다. 전통 음식을 접하기 쉽습니다.",  R.drawable.icon_market))
            add(HashDataVo("도일시장", "5일장이 열리는 재래시장입니다. 새마을운동으로 조성돼 한때는 우시장도 있어 중심지 역활을 했습니다.",  R.drawable.icon_market))
